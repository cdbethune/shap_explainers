...
step_5.add_hyperparameter(name='semantic_types', argument_type=ArgumentType.VALUE,data=('https://metadata.datadrivendiscovery.org/types/PrimaryKey','https://metadata.datadrivendiscovery.org/types/Attribute'))
...
# Final Output
pipeline_description.add_output(name='output', data_reference='steps.7.produce_shap_values')
